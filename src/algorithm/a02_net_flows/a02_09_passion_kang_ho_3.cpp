...
// Passsion Kangho #3 (열혈강호 3)
// N: number of employ, M: number of task (1<= N, M <=1000)
// K: number of employ which can take 2 task in N employs
// Modeling Ref: https://justicehui.github.io/ps/2019/03/17/BOJ11377/
...
void test_a02_09_passion_kang_ho_3() {
    PRINT_FUNC_NAME;
